...
.PHONY: docker-push
docker-push: $(CONFIG_DOCKER_TARGET) ## Push docker image with the manager.
...
.PHONY: docker-buildx
docker-buildx: require-docker-buildx ## Build and push docker image for the manager for cross-platform support
